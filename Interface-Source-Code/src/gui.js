...
async function getBasePath() {
  return await window.electronAPI.getExeDir();
  /*const envPath = window.electronAPI.getEnv('PORTABLE_EXECUTABLE_DIR');
  if (envPath) return envPath;
  return await window.electronAPI.getAppPath(); old way, only works on windows*/
}

// Replace path.resolve and process.env usage:
let mainPath;
let charPath;
...
async function init() {
    ...
    mainPath = window.electronAPI.pathResolve(basePath, 'Resources', 'Texts');
    charPath = window.electronAPI.pathResolve(basePath, 'Resources', 'Characters');
    })();
    ...
    p1Win1 = document.getElementById('winP1-1');
    p1Win2 = document.getElementById('winP1-2');
    p1Win3 = document.getElementById('winP1-3');
    p2Win1 = document.getElementById('winP2-1');
    p2Win2 = document.getElementById('winP2-2');
    p2Win3 = document.getElementById('winP2-3');
    p1W = document.getElementById('p1W');
    p1L = document.getElementById('p1L');
    p2W = document.getElementById('p2W');
    p2L = document.getElementById('p2L');
    roundInp = document.getElementById('roundName');
    formatInp = document.getElementById('format');
    forceWL = document.getElementById('forceWLToggle');
...
function getJson(fileName) {
  try {
    let settingsRaw = window.electronAPI.fsReadFileSync(mainPath + "/" + fileName + ".json");
...
function writeScoreboard() {
    ...
    window.electronAPI.fsWriteFileSync(mainPath + "/ScoreboardInfo.json", data);


    //simple .txt files
    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Player 1.txt", p1NameInp.value);
    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Player 2.txt", p2NameInp.value);

    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Score 1.txt", p1NScoreInp.value);
    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Score 2.txt", p2NScoreInp.value);

    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Round.txt", roundInp.value);
    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Format.txt", formatInp.value);
    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Tournament Name.txt", document.getElementById('tournamentName').value);

    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Caster 1 Name.txt", document.getElementById('cName1').value);
    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Caster 1 Twitter.txt", document.getElementById('cTwitter1').value);
    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Caster 1 Twitch.txt", document.getElementById('cTwitch1').value);

    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Caster 2 Name.txt", document.getElementById('cName2').value);
    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Caster 2 Twitter.txt", document.getElementById('cTwitter2').value);
    window.electronAPI.fsWriteFileSync(mainPath + "/Simple Texts/Caster 2 Twitch.txt", document.getElementById('cTwitch2').value);
